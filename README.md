...
> **Требование:** на сервере должны быть установлены Python-зависимости бота (`pip install -r bot/requirements.txt`). Это разовая операция при первом развёртывании.
