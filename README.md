...
> Ветка `next` — разработка версии **1.x**. Стабильная **0.6.2** находится в
> [ветке main](https://github.com/amirotin/telemt_panel/tree/main).
> До публикации 1.x используйте тестовый стенд или локально собранный бинарник.
...
Команда ниже показывает пример для `v1.0.0`; пока такого релиза нет, используйте
локальный бинарник из следующего примера.
...
Для локально собранной или заранее скачанной панели:
