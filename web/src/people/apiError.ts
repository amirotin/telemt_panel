import { errorMessage, type Dict } from "../i18n";
...
// envelope error.
export function apiErrorMessage(err: { code?: unknown } | undefined, s: Dict): string {
...
// `errorCode` prop, which does its own errorMessage(s) lookup — this only
