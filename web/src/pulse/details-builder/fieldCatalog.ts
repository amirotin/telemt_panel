...
export const WEB_ENDPOINT = "/api/telemt/web";

// The WEB domain (M4 task 8b) is ENDPOINT-SCOPED for the same reason the TLS
// one is (R9): half of what it names — `manager`, `budget`, `streams`,
// `limits`, `permits`, `state`, `attempt`, `host`, `user`, `reason` — is a
// word some other Telemt payload also uses, and a global entry for any of
// them would put a WEB sentence on somebody else's row.
const WEB_ENTRIES: FieldCatalogEntry[] = [
  { path: "lifecycle", descriptionKey: "web.lifecycle", format: "enum", shortLabelKey: "web.lifecycle" },
  { path: "lifecycle_epoch", descriptionKey: "web.lifecycle_epoch", format: "identifier" },
  { path: "lifecycle_age_ms", descriptionKey: "web.lifecycle_age_ms", unit: "milliseconds" },
  { path: "available", descriptionKey: "web.available" },
  { path: "reason", descriptionKey: "web.reason", format: "enum" },
  { path: "effective_config_enabled", descriptionKey: "web.effective_config_enabled" },
  { path: "listeners", descriptionKey: "web.listeners" },
  { path: "listeners.*", descriptionKey: "web.listeners_item" },
  { path: "runtime.runtime_instance", descriptionKey: "web.runtime_instance", format: "identifier" },
  { path: "runtime.generation_id", descriptionKey: "web.generation_id", format: "identifier" },
  { path: "runtime.manager.issuance_enabled", descriptionKey: "web.manager.issuance_enabled" },
  { path: "runtime.manager.issuance_generation", descriptionKey: "web.manager.issuance_generation", format: "identifier" },
  { path: "runtime.manager.shutdown", descriptionKey: "web.manager.shutdown" },
  { path: "runtime.manager.sessions", descriptionKey: "web.manager.sessions", format: "integer", shortLabelKey: "web.manager.sessions" },
  { path: "runtime.manager.bootstraps", descriptionKey: "web.manager.bootstraps", format: "integer" },
  { path: "runtime.manager.client_ips", descriptionKey: "web.manager.client_ips", format: "integer" },
  { path: "runtime.manager.profiles", descriptionKey: "web.manager.profiles", format: "integer" },
  { path: "runtime.manager.closed_sessions", descriptionKey: "web.manager.closed_sessions", format: "integer" },
  { path: "runtime.manager.closed_tokens", descriptionKey: "web.manager.closed_tokens", format: "integer" },
  { path: "runtime.streams.live", descriptionKey: "web.streams.live", format: "integer", shortLabelKey: "web.streams.live" },
  { path: "runtime.streams.profiles", descriptionKey: "web.streams.profiles", format: "integer" },
  { path: "runtime.streams.closed", descriptionKey: "web.streams.closed" },
  { path: "runtime.budget.queue_bytes", descriptionKey: "web.budget.queue_bytes", unit: "bytes" },
  { path: "runtime.budget.queue_items", descriptionKey: "web.budget.queue_items", format: "integer" },
  { path: "runtime.budget.control_bytes", descriptionKey: "web.budget.control_bytes", unit: "bytes" },
  { path: "runtime.budget.control_items", descriptionKey: "web.budget.control_items", format: "integer" },
  { path: "runtime.budget.websocket_bytes", descriptionKey: "web.budget.websocket_bytes", unit: "bytes" },
  { path: "runtime.budget.high_water_bytes", descriptionKey: "web.budget.high_water_bytes", unit: "bytes" },
  { path: "runtime.budget.owners", descriptionKey: "web.budget.owners", format: "integer" },
  { path: "runtime.budget.closed", descriptionKey: "web.budget.closed" },
  { path: "runtime.websockets.entries", descriptionKey: "web.websockets.entries", format: "integer" },
  { path: "runtime.websockets.claims", descriptionKey: "web.websockets.claims", format: "integer" },
  { path: "runtime.websockets.evictions_in_flight", descriptionKey: "web.websockets.evictions_in_flight", format: "integer" },
  { path: "runtime.websockets.closed", descriptionKey: "web.websockets.closed" },
  { path: "runtime.learning.enabled", descriptionKey: "web.learning.enabled" },
  { path: "runtime.learning.aggressiveness", descriptionKey: "web.learning.aggressiveness", format: "enum" },
  { path: "runtime.learning.entries", descriptionKey: "web.learning.entries", format: "integer" },
  { path: "runtime.learning.capacity", descriptionKey: "web.learning.capacity", format: "integer" },
  { path: "runtime.learning.lifetime_secs", descriptionKey: "web.learning.lifetime_secs", unit: "seconds" },
  { path: "runtime.learning.age_ms", descriptionKey: "web.learning.age_ms", unit: "milliseconds" },
  { path: "runtime.learning.epoch", descriptionKey: "web.learning.epoch", format: "identifier" },
  { path: "runtime.debug.records", descriptionKey: "web.debug.records", format: "integer" },
  { path: "runtime.debug.records_capacity", descriptionKey: "web.debug.records_capacity", format: "integer" },
  { path: "runtime.debug.used_bytes", descriptionKey: "web.debug.used_bytes", unit: "bytes" },
  { path: "runtime.debug.bytes_capacity", descriptionKey: "web.debug.bytes_capacity", unit: "bytes" },
  { path: "runtime.debug.earliest_seq", descriptionKey: "web.debug.earliest_seq", format: "identifier" },
  { path: "runtime.debug.latest_seq", descriptionKey: "web.debug.latest_seq", format: "identifier" },
  { path: "runtime.debug.contention_drops", descriptionKey: "web.debug.contention_drops", format: "integer" },
  { path: "runtime.debug.evictions", descriptionKey: "web.debug.evictions", format: "integer" },
  { path: "runtime.debug.byte_truncations", descriptionKey: "web.debug.byte_truncations", format: "integer" },
  { path: "runtime.debug.epoch", descriptionKey: "web.debug.epoch", format: "identifier" },
  { path: "runtime.debug.policy_generation", descriptionKey: "web.debug.policy_generation", format: "identifier" },
  { path: "runtime.debug.policy", descriptionKey: "web.debug.policy" },
  { path: "runtime.debug.policy.*", descriptionKey: "web.debug.policy_field" },
  { path: "runtime.manager", descriptionKey: "web.plane.manager" },
  { path: "runtime.streams", descriptionKey: "web.plane.streams" },
  { path: "runtime.budget", descriptionKey: "web.plane.budget" },
  { path: "runtime.websockets", descriptionKey: "web.plane.websockets" },
  { path: "runtime.learning", descriptionKey: "web.plane.learning" },
  { path: "runtime.debug", descriptionKey: "web.plane.debug" },
  { path: "runtime.permits", descriptionKey: "web.permits" },
  { path: "runtime.permits.*.name", descriptionKey: "web.permits.name", format: "identifier" },
  { path: "runtime.permits.*.used", descriptionKey: "web.permits.used", format: "integer" },
  { path: "runtime.permits.*.available", descriptionKey: "web.permits.available", format: "integer" },
  { path: "runtime.permits.*.capacity", descriptionKey: "web.permits.capacity", format: "integer" },
  { path: "runtime.permits.*.closed", descriptionKey: "web.permits.closed" },
  { path: "runtime.limits", descriptionKey: "web.limits" },
  { path: "runtime.limits.*", descriptionKey: "web.limits_field" },
  { path: "runtime.bytes_up", descriptionKey: "web.totals.bytes_up", unit: "bytes", shortLabelKey: "web.totals.bytes_up" },
  { path: "runtime.bytes_down", descriptionKey: "web.totals.bytes_down", unit: "bytes", shortLabelKey: "web.totals.bytes_down" },
  { path: "runtime.streams_opened", descriptionKey: "web.totals.streams_opened", format: "integer" },
  { path: "runtime.streams_rejected", descriptionKey: "web.totals.streams_rejected", format: "integer" },
  { path: "runtime.session_incarnations_created", descriptionKey: "web.totals.session_incarnations_created", format: "integer" },
  { path: "runtime.session_incarnations_closed", descriptionKey: "web.totals.session_incarnations_closed", format: "integer" },
  { path: "runtime.limit_hits", descriptionKey: "web.totals.limit_hits", format: "integer", shortLabelKey: "web.totals.limit_hits" },
  { path: "runtime.auxiliary_tasks", descriptionKey: "web.totals.auxiliary_tasks", format: "integer" },
  { path: "runtime.partial", descriptionKey: "web.partial" },
  { path: "runtime.partial.*", descriptionKey: "web.partial_item", format: "enum" },
  { path: "sessions.next_cursor", descriptionKey: "web.sessions.next_cursor", format: "identifier" },
  { path: "sessions.scanned", descriptionKey: "web.sessions.scanned", format: "integer" },
  { path: "sessions.scan_truncated", descriptionKey: "web.sessions.scan_truncated" },
  { path: "sessions.partial_sessions", descriptionKey: "web.sessions.partial_sessions", format: "integer" },
  { path: "sessions.partial", descriptionKey: "web.sessions.partial" },
  { path: "sessions.partial.*", descriptionKey: "web.partial_item", format: "enum" },
  { path: "sessions.rows.*.session_ref", descriptionKey: "web.session.session_ref", format: "identifier" },
  { path: "sessions.rows.*.user_agent", descriptionKey: "web.session.user_agent" },
  { path: "sessions.rows.*.user_agent_id", descriptionKey: "web.session.user_agent_id", format: "identifier" },
  { path: "sessions.rows.*.trace_session_id", descriptionKey: "web.session.trace_session_id", format: "identifier" },
  { path: "sessions.rows.*.client_ip", descriptionKey: "web.session.client_ip" },
  { path: "sessions.rows.*.host", descriptionKey: "web.session.host" },
  { path: "sessions.rows.*.user", descriptionKey: "web.session.user" },
  { path: "sessions.rows.*.key_id", descriptionKey: "web.session.key_id", format: "identifier" },
  { path: "sessions.rows.*.carrier", descriptionKey: "web.session.carrier", format: "enum" },
  { path: "sessions.rows.*.attempt", descriptionKey: "web.session.attempt", format: "integer" },
  { path: "sessions.rows.*.client_class", descriptionKey: "web.session.client_class", format: "enum" },
  { path: "sessions.rows.*.automatic", descriptionKey: "web.session.automatic" },
  { path: "sessions.rows.*.state", descriptionKey: "web.session.state", format: "enum" },
  { path: "sessions.rows.*.streams", descriptionKey: "web.session.streams", format: "integer" },
  { path: "sessions.rows.*.tasks", descriptionKey: "web.session.tasks", format: "integer" },
  { path: "sessions.rows.*.lanes", descriptionKey: "web.session.lanes", format: "integer" },
  { path: "sessions.rows.*.lane_open_waits", descriptionKey: "web.session.lane_open_waits", format: "integer" },
  { path: "sessions.rows.*.websocket_lane_reservations", descriptionKey: "web.session.websocket_lane_reservations", format: "integer" },
  { path: "sessions.rows.*.websocket_active", descriptionKey: "web.session.websocket_active" },
  { path: "sessions.rows.*.pending_bytes", descriptionKey: "web.session.pending_bytes", unit: "bytes" },
  { path: "sessions.rows.*.pending_items", descriptionKey: "web.session.pending_items", format: "integer" },
  { path: "sessions.rows.*.control_bytes", descriptionKey: "web.session.control_bytes", unit: "bytes" },
  { path: "sessions.rows.*.control_items", descriptionKey: "web.session.control_items", format: "integer" },
  { path: "sessions.rows.*.age_ms", descriptionKey: "web.session.age_ms", unit: "milliseconds" },
  { path: "sessions.rows.*.idle_ms", descriptionKey: "web.session.idle_ms", unit: "milliseconds" },
  { path: "sessions.rows.*.negotiation_remaining_ms", descriptionKey: "web.session.negotiation_remaining_ms", unit: "milliseconds" },
  { path: "sessions.rows.streams", descriptionKey: "web.session.streams", format: "integer" },
  { path: "sessions.rows.age_ms", descriptionKey: "web.session.age_ms", unit: "milliseconds" },
  { path: "sessions.rows", descriptionKey: "web.sessions.rows" },
];
...
export const DEFAULT_FIELD_CATALOG: FieldCatalog = {
  ...
  byEndpoint: {
    [TLS_FINGERPRINTS_ENDPOINT]: TLS_ENTRIES,
    [WEB_ENDPOINT]: WEB_ENTRIES,
  },
};
