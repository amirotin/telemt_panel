// Production-size Telemt fixtures for diagnostic views and adapters.
//
...
// fixtures exercise the production cardinalities rather than a deceptively
// small three-element mock.
//
