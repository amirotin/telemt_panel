...
import { placementFor, useLayoutMode } from "./layoutMode";
...
// AdaptiveDetailSurface is the surface a WEB session row opens. It is a
// thin adapter over ui/Sheet rather than a second dialog
