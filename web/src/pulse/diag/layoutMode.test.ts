...
import { isCompact, isSplitLayout, layoutModeFor, placementFor, useLayoutMode } from "./layoutMode";
...
// matrix protects the live WEB detail surface. The thresholds are the
// contract, not the implementation that reads them.
