...
export const ru = {
  ...
  pulse: {
    ...
    dc: {
      ...
      rttUnit: "мс",
      // Доступное имя узла (концепция §9): кольцо, точки и число кодируют
      ...
      // Приглушённое кольцо — единственный признак тестового ДЦ на экране.
      testSite: "тестовый дата-центр",
    },
    upstreams: {
      route: "Маршрут",
      healthy: "Здоров",
