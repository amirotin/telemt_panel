...
export const ru = {
  ...
  shell: {
    ...
    storageFallbackTitle: "База истории недоступна",
    storageFallbackBody:
      "Новая история временно пишется в память; сессии, двухэтапный вход и настройки панели от этой базы не зависят. Проверьте {driver} и перезапустите панель — автоматического слияния истории не будет.",
  ...
  server: {
    ...
    settings: {
      ...
      twoFactorUnavailable: "Недоступен",
      ...
      twoFactorUnavailableNote:
        "Настройка хранится в недоступной сетевой БД и появится после восстановления и перезапуска.",
      ...
      passkeyUnavailableNote:
        "Passkeys хранятся в недоступной сетевой базе и вернутся после её восстановления и перезапуска.",
      ...
      storageFallbackWarning:
        "База истории {driver} недоступна. Новая история до перезапуска хранится в памяти и не переносится обратно автоматически.",
