...
export const ru = {
  ...
  shell: {
    ...
    storageFallbackBody:
      "Панель временно пишет данные в память; сессии и двухэтапный вход из БД недоступны. Проверьте {driver} и перезапустите панель — автоматического слияния данных не будет.",
