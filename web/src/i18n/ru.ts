...
export const ru = {
  ...
  auth: {
    ...
    signingIn: "Вход…",
    signOut: "Выйти",
    secondFactorTitle: "Подтвердите вход",
    secondFactorNote: "Введите код из приложения-аутентификатора.",
    recoveryCodeNote: "Введите один из сохранённых резервных кодов.",
    secondFactorInvalid: "Код не подходит или уже был использован.",
    authenticatorCode: "6-значный код",
    recoveryCode: "Резервный код",
    useRecoveryCode: "Использовать резервный код",
    useAuthenticatorCode: "Использовать код из приложения",
    changeAccount: "Назад к логину и паролю",
    or: "или",
  ...
  hub: {
    ...
    userTraffic: {
      ...
      historyDisabled: "Графики отключены в настройках хранения",
  ...
  server: {
    ...
    settings: {
      ...
      twoFactorEyebrow: "Защита аккаунта",
      twoFactorTitle: "Двухэтапный вход",
      twoFactorEnabled: "Включён",
      twoFactorDisabled: "Не настроен",
      twoFactorEnabledNote: "После пароля панель запрашивает код из приложения или резервный код.",
      twoFactorDisabledNote: "Добавьте второй фактор, чтобы одного пароля было недостаточно для входа.",
      twoFactorEnable: "Настроить",
      twoFactorDisable: "Отключить",
      twoFactorSetupTitle: "Подключение аутентификатора",
      twoFactorSetupNote: "Отсканируйте QR-код в приложении, затем введите текущий код.",
      twoFactorLoading: "Создаём защищённую настройку…",
      twoFactorScan: "Сканировать в приложении",
      twoFactorManual: "Или ввести ключ вручную",
      twoFactorCode: "6-значный код",
      twoFactorConfirm: "Подтвердить и включить",
      twoFactorRecoveryTitle: "Сохраните резервные коды",
      twoFactorRecoveryNote:
        "Каждый код работает один раз. Они не будут показаны снова после закрытия этого окна.",
      twoFactorCopyCodes: "Копировать все",
      twoFactorDownloadCodes: "Скачать .txt",
      twoFactorCodesCopied: "Резервные коды скопированы",
      twoFactorCodesDownloaded: "Файл с резервными кодами сохранён",
      twoFactorSavedAck: "Я сохранил резервные коды в безопасном месте",
      twoFactorCloseWarning: "Сначала подтвердите, что сохранили коды — восстановить их позже нельзя.",
      twoFactorDone: "Готово",
      twoFactorEnabledToast: "Двухэтапный вход включён",
      twoFactorDisableTitle: "Отключить двухэтапный вход?",
      twoFactorDisableNote:
        "Для следующих входов снова будет достаточно одного пароля. Неиспользованные резервные коды удалятся.",
      twoFactorDisabledToast: "Двухэтапный вход отключён",
      ...
      authPassword: "Пароль",
      authPasswordTotp: "Пароль + код приложения",
      authPasswordRecovery: "Пароль + резервный код",
  ...
  errors: {
    ...
    invalid_totp: "Код неверен, настройка истекла или была начата заново.",
    totp_already_enabled: "Двухэтапный вход уже включён.",
    totp_setup_changed: "Настройка изменилась или истекла. Начните подключение заново.",
  ...
  auditActions: {
    ...
    logout: "Выход",
    "totp.enable": "Включён двухэтапный вход",
    "totp.disable": "Отключён двухэтапный вход",
